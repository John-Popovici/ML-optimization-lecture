...
## How to Run
1. Ensure you have an IDE, Python and uv installed

2. Clone the repository
```bash
git clone <repository_url>
cd ML-optimization-lecture
```
...
4. Open the Jupyter notebook in your IDE, and open `optimization.ipynb` to run the demonstrations.
```bash
code .
```
